                                    ...
                                    <div class="card">
                                        ...
                                        <div class="p-0 card-body">
                                            <ul class="clearfix users-list">
                                                <li>
                                                    <img src="{{ asset('dashboard/dist/img/user1-128x128.jpg') }}"
                                                        alt="User Image">
                                                    <a class="users-list-name" href="#">Alexander Pierce</a>
                                                    <span class="users-list-date">Today</span>
                                                </li>
                                                <li>
                                                    <img src="{{ asset('dashboard/dist/img/user8-128x128.jpg') }}"
                                                        alt="User Image">
                                                    <a class="users-list-name" href="#">Norman</a>
                                                    <span class="users-list-date">Yesterday</span>
                                                </li>
                                                <li>
                                                    <img src="{{ asset('dashboard/dist/img/user7-128x128.jpg') }}"
                                                        alt="User Image">
                                                    <a class="users-list-name" href="#">Jane</a>
                                                    <span class="users-list-date">12 Jan</span>
                                                </li>
                                                <li>
                                                    <img src="{{ asset('dashboard/dist/img/user6-128x128.jpg') }}"
                                                        alt="User Image">
                                                ...
                                                <li>
                                                    <img src="{{ asset('dashboard/dist/img/user5-128x128.jpg') }}"
                                                        alt="User Image">
